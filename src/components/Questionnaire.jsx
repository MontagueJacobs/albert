...
const PRE_QUESTIONS = [
  ...
  },
  {
    ...
    text: 'To what extent do you agree: "Organic (bio) products have significantly lower CO₂ emissions than non-organic products."',
    textNl: 'In hoeverre bent u het eens met: "Biologische producten hebben aanzienlijk lagere CO₂-uitstoot dan niet-biologische producten."',
    type: 'scale',
    options: [
  ...
  },
  {
    ...
    text: 'To what extent do you agree: "I use organic labels as an indicator of environmental impact."',
    textNl: 'In hoeverre bent u het eens met: "Ik gebruik biologische keurmerken als indicator voor milieu-impact."',
    type: 'scale',
    options: [
      { value: 1, label: 'Strongly disagree', labelNl: 'Helemaal mee oneens' },
      { value: 2, label: 'Disagree', labelNl: 'Mee oneens' },
