...
const TRANSLATIONS = {
  nl: {
    ...
    feature_how_desc: 'Lees hoe de duurzaamheidsscore en aanbevelingen worden berekend',
    ...
    how_table_examples: {
      ...
      8: 'Tomaten, tofu, eieren, melk',
      7: 'Kip, pindakaas',
      6: 'Varkensvlees, vis',
      5: 'Kaas, boter, koffie',
      4: 'Garnalen, pure chocolade',
      3: 'Rundvlees, lamsvlees',
    ...
    catalog_badge_vegetarian: 'Vegetarisch',
    catalog_badge_animal: 'Dierlijk',
  ...
  en: {
    ...
    feature_how_desc: 'Learn how sustainability scores and recommendations are calculated',
  ...
  tab_experiment: 'CO₂ Experiment',
    ...
    how_table_examples: {
      ...
      8: 'Tomatoes, tofu, eggs, milk',
      7: 'Chicken, peanut butter',
      6: 'Pork, fish',
      5: 'Cheese, butter, coffee',
      4: 'Shrimp, dark chocolate',
      3: 'Beef, lamb',
    ...
    catalog_badge_vegan: 'Vegan',
    catalog_badge_vegetarian: 'Vegetarian',
    catalog_badge_animal: 'Animal',
