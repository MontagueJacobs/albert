...
const TRANSLATIONS = {
  nl: {
    ...
    feature_sync_desc: 'Koppel je Albert Heijn account voor automatische synchronisatie',
    feature_history_desc: 'Bekijk al je eerdere aankopen en scores',
  ...
  en: {
    ...
    feature_sync_desc: 'Connect your Albert Heijn account for automatic syncing',
    feature_history_desc: 'Review all your past purchases and scores',
