...
// Score thresholds (kg CO2/kg to 1-10 score)
// Lower CO2 = higher score (better). 10 = best, 1 = worst.
const SCORE_THRESHOLDS = [
  { maxCO2: 1.0,    score: 10 },   // < 1 kg CO2/kg = score 10 (best)
  { maxCO2: 2.0,    score: 9 },    // 1-2 kg = score 9 (excellent)
  { maxCO2: 4.0,    score: 8 },    // 2-4 kg = score 8 (very good)
  { maxCO2: 6.0,    score: 7 },    // 4-6 kg = score 7 (good)
  { maxCO2: 10.0,   score: 6 },    // 6-10 kg = score 6 (above average)
  { maxCO2: 18.0,   score: 5 },    // 10-18 kg = score 5 (average)
  { maxCO2: 28.0,   score: 4 },    // 18-28 kg = score 4 (below average)
  { maxCO2: 45.0,   score: 3 },    // 28-45 kg = score 3 (high)
  { maxCO2: 80.0,   score: 2 },    // 45-80 kg = score 2 (very high)
  { maxCO2: Infinity, score: 1 }   // > 80 kg = score 1 (worst)
]
...
/**
 * Convert CO2 emissions to a 1-10 sustainability score
 * Lower CO2 = higher score (better). 10 = best, 1 = worst.
 * @param {number} co2PerKg - CO2 emissions in kg CO2/kg food
 * @returns {number} - Score from 1-10 (10 = best)
 */
 ...
 * @param {number} score - Score 1-10 (10 = best, 1 = worst)
