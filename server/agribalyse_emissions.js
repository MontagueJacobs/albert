...
const AGRIBALYSE_EMISSIONS = {
  ...
  honey:           { mean:  1.57,  min:  1.57,  max:  1.57,  n:   1, note: 'Honey [1.57] — AGRIBALYSE' },
  maple_syrup:     { mean:  2.3,   min:  2.3,   max:  2.3,   n:   1, note: 'Syrup, maple [2.3] — AGRIBALYSE' },
  agave_syrup:     { mean:  5.63,  min:  5.63,  max:  5.63,  n:   1, note: 'Syrup, agave [5.63] — AGRIBALYSE' },
